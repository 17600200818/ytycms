...
@section('content')
    <table class="table table-bordered table-striped datatable" id="Table">
        ...
        <tr v-for="(v, key) in pictures">
            ...
            <td>@{{ v.username }}</td>
            <td>
                <a :href="'/admin/pictures/'+v.id+'/edit'" class="btn btn-default btn-sm btn-icon icon-left">
    ...
    <a href="{{ route('admin.pictures.create', 0) }}" class="btn btn-primary">
        ...
        var vm = new Vue({
            ...
            methods: {
                'sub': function (id, index) {
                    ...
                    this.$http.post('{{ route('admin.pictures.delete') }}',
                ...
                'setListOrder': function (index) {
                    ...
                    var id = picture.id;
                    var listorder = picture.listorder;
                    this.$http.post('{{ route('admin.pictures.setListOrder') }}',
