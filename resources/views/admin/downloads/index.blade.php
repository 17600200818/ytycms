...
@section('content')
    <table class="table table-bordered table-striped datatable" id="Table">
        ...
        <tr v-for="(v, key) in list">
            ...
            <td>@{{ v.username }}</td>
            <td>
                <a :href="'/admin/downloads/'+v.id+'/edit'" class="btn btn-default btn-sm btn-icon icon-left">
    ...
    <a href="{{ route('admin.downloads.create', 0) }}" class="btn btn-primary">
        ...
        var vm = new Vue({
            ...
            methods: {
                'sub': function (id, index) {
                    ...
                    this.$http.post('{{ route('admin.downloads.delete') }}',
                ...
                'setListOrder': function (index) {
                    ...
                    this.$http.post('{{ route('admin.downloads.setListOrder') }}',
