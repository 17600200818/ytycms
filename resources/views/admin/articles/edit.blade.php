                ...
                <div class="panel-body">
                    ...
                    <form role="form" class="form-horizontal form-groups-bordered" action="{{ route('admin.articles.update', $article->id) }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                <textarea class="form-control" name="description" id="" cols="30" rows="10"description>{{ $article->description }}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                <input type="text" class="form-control" name="fromlink" value="{{ $article->fromlink }}"/>
                            </div>
                        </div>
...
@section('script')
    ...
    <script type="text/javascript">
        ...
        ue.ready(function() {//编辑器初始化完成再赋值
            ue.setContent('{!! $article->content !!}');  //赋值给UEditor
        });
