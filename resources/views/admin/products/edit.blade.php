        ...
        <div class="col-xs-12">
            ...
            <div class="panel panel-primary" data-collapsed="0">
                ...
                <div class="panel-body">
                    ...
                    <form role="form" class="form-horizontal form-groups-bordered" action="{{ route('admin.products.update', $product->id) }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                <textarea class="form-control" name="description" id="" cols="30" rows="10"description>{{ $product->description }}</textarea>
                            </div>
                        </div>

                        <div class="form-group">
                            <label for="field-1" class="col-sm-2 control-label">型号</label>

                            <div class="col-sm-5">
                                <input type="text" class="form-control" name="xinghao" value="{{ $product->xinghao }}" />
                            </div>
                        </div>

                        <div class="form-group">
                            <label for="field-1" class="col-sm-2 control-label">价格</label>
                        ...
                        <div class="form-group">
                            <label for="field-1" class="col-sm-2 control-label">图片</label>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-5">
                    <div class="date-and-time">
                        ...
                        <input type="text" class="form-control timepicker" name="start_at2" data-template="dropdown" data-default-time="0:00" data-show-meridian="false" data-minute-step="1" value="{{ $startAt1 }}">
                    </div>
                </div>
            </div>
